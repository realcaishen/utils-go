...
CREATE TABLE `t_cctp_support_chain` (
    `chainid` int NOT NULL,
    `min_value` varchar(128) NOT NULL DEFAULT 0,
    `domain` int NOT NULL DEFAULT '-1',
    `token_messenger` varchar(128) NOT NULL DEFAULT '',
    `message_transmitter` varchar(128) NOT NULL DEFAULT '',
    `token_messengerv2` varchar(128) NOT NULL DEFAULT '',
    `message_transmitterv2` varchar(128) NOT NULL DEFAULT '',
    PRIMARY KEY (`chainid`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `t_src_transaction` (
    ...
    `dst_tx_hash` varchar(128) DEFAULT NULL,
    `dst_value` varchar(128) DEFAULT NULL,
    `is_verified` int DEFAULT '0',
    `dst_gas` varchar(128) DEFAULT NULL,
    `dst_gas_used` varchar(128) DEFAULT NULL,
    `dst_gas_price` varchar(128) DEFAULT NULL,
    `is_testnet` int DEFAULT NULL,
    `next_time` int NOT NULL DEFAULT '0',
    `bridge_fee` varchar(128) NOT NULL DEFAULT '0',
    `src_nonce` int NOT NULL DEFAULT '-1',
    `dst_nonce` int NOT NULL DEFAULT '-1',
    `dst_estimated_gas_limit` varchar(128) DEFAULT NULL,
    `dst_estimated_gas_price` varchar(128) DEFAULT NULL,
    `dst_max_fee_per_gas` varchar(128) DEFAULT NULL,
    `tx_timestamp` int NOT NULL DEFAULT '2147483647',
    `is_locked` int NOT NULL DEFAULT '0',
    `src_token_name` varchar(32) DEFAULT NULL,
    `src_token_decimal` int DEFAULT NULL,
    `gas_token_name` varchar(32) DEFAULT NULL,
...
CREATE TABLE `t_lp_info` (
    ...
    `maker_address` varchar(128) NOT NULL,
    `min_value` varchar(32) NOT NULL,
    `max_value` varchar(32) NOT NULL,
    `dtc` varchar(32) NOT NULL,
    `bridge_fee_ratio` varchar(32) NOT NULL,
